...
var minutesInGivenSeconds :number= Math.floor (givenseconds / 60 ) ;
var remainingseconds : number = (givenseconds%60 ) 
...
// calculate the percentage 
 ...
 //Example usage 
 var givendays = 24;
 var weeksInGivenDays :number = Math.floor(givendays / 7) ;
 var remainingdays :number =  givendays % 7 ;
 ...
 var name5 : string = "maira"
 var sentence : string =  `my name is ${name5}`;
